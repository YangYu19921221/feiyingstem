...
- ✅ 作业定时布置(2026-08): 创建作业可选「开始日期」(homework_assignments.available_from,
  北京日0点开放),开放前学生端不可见/不解锁单元/不计金币口径(assigned_at对齐开放时间);
  多选单元+「按天依次排期」每单元顺延一天,一次布置未来一周;入口: 作业管理→创建新作业
