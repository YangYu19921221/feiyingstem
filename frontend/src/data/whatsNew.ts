...
export const WHATS_NEW: WhatsNewEntry[] = [
  {
    ...
    desc: '图鉴一次加了 20 个家族,一共 60 个。其中 8 只是传说宝可梦,它们不看你喂了多少粮,只看一件事:你一共学会了多少个不同的单词。累计 2500 个单词,急冻鸟、闪电鸟、火焰鸟、水君会现身;累计 5000 个,梦幻、超梦、烈空坐、阿尔宙斯才会认你当训练家。传说有自己的专属队伍格,不占原来的 5 个名额——也就是说队伍满了照样能收传说,你攒下的每一个单词都不会白费。没到门槛的传说在图鉴里是灰的,卡片上直接写着「还差多少词」,一眼看到自己离它有多远。另外 12 个新家族补上了冰、恶、地面、毒、飞行这些以前一只都没有的属性,对战里的属性克制终于转得起来了。',
