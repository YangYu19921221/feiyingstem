  ...
  return (
    <article className="fk-serif text-[14px] leading-7 text-slate-900">
      ...
      <Clause no="四" title="区域保护">
        <p>
          自本协议生效之日起,甲方在乙方上述经营场所导航距离<strong>两公里</strong>范围内,不再发展其他合作点。
        </p>
      </Clause>
    ...
    <article className="text-[13.5px] leading-6 text-slate-800">
      ...
      <PitchSection no="八" title="合作方案:一笔算得清的账">
        ...
        <p className="mt-3">
          ...
          机构若将系统打包进课程、或按 300–500 元 / 年向学员收取智能学习服务费,100 名学生对应 3–5 万元年流水,
          系统成本 1.2 万元;一节课时费,就覆盖一个学生全年的系统成本。
        </p>
      </PitchSection>
      ...
      <PitchSection no="九" title="为什么可以放心合作">
        <ul className="list-disc space-y-1 pl-5">
          <li><strong>区域保护</strong>:经营场所导航两公里内不再发展第二家合作点,写进协议。</li>
