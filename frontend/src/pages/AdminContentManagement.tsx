  ...
  const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (!validTypes.includes(file.type) && !file.name.endsWith('.xlsx') && !file.name.endsWith('.xls') && !file.name.endsWith('.csv')) {
        toast.warning('请上传Excel文件(.xlsx, .xls)或CSV文件');
        return;
      }
      setUploadFile(file);
    }
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex border-b">
            <button
              ...
              className={`flex-1 py-4 px-6 font-medium transition-colors ${
                activeTab === 'wordbooks'
                  ? 'text-[#3976a9] border-b-2 border-[#3976a9]'
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#3976a9]/30 focus:border-[#3976a9]"
                />
                <select
                  ...
                  className="px-4 py-2 border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#3976a9]/30 focus:border-[#3976a9]"
                >
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#3976a9] text-white rounded-lg hover:bg-[#2e628f] transition-colors font-semibold"
                >
                  📤 批量上传
                </button>
              </div>
        ...
        {showUploadModal && (
          <div className="fixed inset-0 bg-slate-950/40 flex items-center justify-center z-50 p-4">
            <div className="bg-white border border-slate-200 rounded-xl shadow-xl p-5 sm:p-7 max-w-2xl w-full mx-4">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-[#3976a9] file:text-white hover:file:bg-[#2e628f] transition-colors"
                />
                {uploadFile && (
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-[#3976a9] text-white rounded-lg hover:bg-[#2e628f] transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                >
                  {uploading ? '上传中...' : '开始上传'}
                </button>
              </div>
