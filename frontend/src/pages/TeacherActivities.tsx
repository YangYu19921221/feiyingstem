...
const TeacherActivities = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f8fc] text-slate-800">
      <StaffWorkspaceHeader role="teacher" title="学生动态" subtitle="最近完成情况与学习信号" action={<button type="button" onClick={() => navigate('/teacher/homework')} className="teacher-secondary teacher-focus-ring inline-flex min-h-10 items-center justify-center rounded-xl px-3 py-2 text-sm font-semibold transition">作业管理 →</button>} />
