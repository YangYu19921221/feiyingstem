        ...
        >
          ...
          >
            ...
            <Section icon="⏱️" title="学习时长 = 真正在学的时间,不是开着页面的时间">
              ...
              <p>· <b>发呆</b>:连续 1 分钟没有任何操作,这一整段都不计入(包括判定前的那 1 分钟),人回来才继续算;</p>
              ...
              <p className="text-gray-400 text-[11px] mt-1">
                口径说明:每天取「学习会话时长」与「净活动时长」中较大的一个(单次学习最多算 2 小时、
                单天最多算 12 小时),再按天相加。学生端、家长端、教师端各处用的都是这一套算法,数字应当一致;
                2026-07-09 之前的历史时长是旧算法留下的虚高值,已按上限挡住。
              </p>
            </Section>
